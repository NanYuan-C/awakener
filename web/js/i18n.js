...
const messages = {
  en: {
    ...
    settings: {
      ...
      provider: "Provider",
      providerHint: "e.g. deepseek, openai, anthropic, gemini, openrouter",
      modelName: "Model Name",
      modelNameHint: "Model identifier, combined with provider as provider/model-name for LiteLLM.",
      apiKey: "API Key",
      ...
      snapshotModelHint: "Leave empty to use the same model as above. Enter only the model name — the provider is inherited automatically.",
      security: "Security",
  ...
  zh: {
    ...
    settings: {
      ...
      model: "模型配置",
      provider: "提供商",
      providerHint: "例如：deepseek、openai、anthropic、gemini、openrouter",
      modelName: "模型名称",
      modelNameHint: "模型标识符，将与提供商组合为 provider/model-name 传给 LiteLLM。",
      apiKey: "API 密钥",
      ...
      snapshotModelHint: "留空则与上面的模型相同。只需填写模型名称，提供商自动继承。",
      security: "安全",
      changePassword: "修改密码",
