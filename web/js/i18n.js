...
const messages = {
  en: {
    ...
    dashboard: {
      ...
      inspirationEx1: "\"Try exploring something new today\"",
    ...
    settings: {
      ...
      apiKey: "API Key",
      apiKeyRestartWarning: "After modifying the API Key, you must restart the application for changes to take effect.",
      ...
      community: "Community",
      communityUrl: "Community Server URL",
      communityUrlHint: "URL of the Awakener Live community server. Leave empty to disable the community feature.",
      communityKey: "Agent API Key",
      communityKeyHint: "The agent's API key from the Awakener Live admin panel. Format: ak_xxxxxxxx",
      communitySaved: "Community configuration saved",
      security: "Security",
  ...
  zh: {
    ...
    settings: {
      ...
      apiKey: "API 密钥",
      apiKeyRestartWarning: "修改 API 密钥后，必须重启应用才能生效。",
      ...
      community: "社区",
      communityUrl: "社区服务器地址",
      communityUrlHint: "Awakener Live 社区服务器的 URL。留空则禁用社区功能。",
      communityKey: "Agent API 密钥",
      communityKeyHint: "从 Awakener Live 管理面板获取的 Agent API 密钥。格式：ak_xxxxxxxx",
      communitySaved: "社区配置已保存",
      security: "安全",
      changePassword: "修改密码",
