...
const messages = {
  en: {
    ...
    settings: {
      ...
      maxIndexChars: "Index Character Limit",
      maxIndexCharsHint: "Maximum characters injected from knowledge/index.md into the prompt each round. The agent's index is truncated if it exceeds this limit.",
      security: "Security",
  ...
  zh: {
    ...
    settings: {
      ...
      knowledgeBase: "知识库",
      maxIndexChars: "索引字符限制",
      maxIndexCharsHint: "每轮注入到提示词中的 knowledge/index.md 最大字符数。超出限制时索引会被截断。",
      security: "安全",
      changePassword: "修改密码",
